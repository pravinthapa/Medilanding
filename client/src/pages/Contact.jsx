    ...
    <div ref={pageRef}>
      ...
      <Section className="bg-white dark:bg-slate-950">
        <div className="grid gap-12 lg:grid-cols-2">
          <div>
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={item.label} className="gsap-reveal flex gap-4">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary-100 text-primary-600 dark:bg-primary-900/50">
          ...
          <div className="gsap-reveal glass-card p-6 sm:p-8">
            ...
            >
              ...
              <textarea name="message" value={form.message} onChange={(e) => setForm({ ...form, [e.target.name]: e.target.value })} required rows={5} placeholder="Message *" className="input-field" />
      ...
      <Section className="bg-slate-50 p-0 dark:bg-slate-900/50">
        <div className="gsap-reveal overflow-hidden rounded-2xl shadow-xl">
          <iframe
            title="Clinic map"
